        ...
        <header
            ...
            <div class="flex items-center gap-4 flex-1 overflow-hidden min-w-0">
                ...
                <div class="flex items-center gap-2 pr-4 border-r border-gray-200 shrink-0">
                    <div
                        class="h-8 w-8 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 flex items-center justify-center text-white text-xs font-bold shadow-sm cursor-default">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="text-xs text-gray-400 hover:text-red-500 ml-1 transition-colors"
                            title="Sign Out">
